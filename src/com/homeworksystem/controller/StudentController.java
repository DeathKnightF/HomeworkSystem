...
//	 * @return
//	 */
//	@RequestMapping("toChooseCoursePage/{studentId}")
//	public ModelAndView chooseCourse(@PathVariable("studentId")String studentId) {
//		System.out.println("即将进入选课页面"+studentId);
//		//从数据库中获取课程数据，用于页面展示
//		
//		ModelAndView mv=new ModelAndView("chooseCourse");
//		List<Course> courses = courseService.selectAll();
//		mv.addObject("allTheCourses", courses);
...
//	 * @return
//	 */
//	@RequestMapping("toChooseQuestionPage/{studentId}")
//	public ModelAndView toChooseQuestion(@PathVariable("studentId")String studentId) {
//		//从数据库中获取所有学生id为studentId所选课程老师布置问题的信息，用于在页面展示
//		ModelAndView mv=new ModelAndView("chooseQuestion");
//		List<Question> questions = questionService.selectByStudentId(studentId);
//		Timestamp current=new Timestamp(System.currentTimeMillis());
//		questions.forEach( (q) -> q.setIsLate(current.after(q.getDeadline())));
